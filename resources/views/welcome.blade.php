...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
       <!--hero section-->
<section id="home" class="relative min-h-screen bg-[#071A35] overflow-hidden flex items-center justify-center">
@if(session('success'))
   <div class="bg-green-500 rounded-xl text-white-500 p-4 mb-6">{{ session('success') }}</div>
@endif
<nav class="fixed top-0 left-0 w-full z-50 fixed bg-slate-900">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-6">

        <h1 class="text-2xl font-bold text-white">
            DevPraise<span class="text-cyan-400">.</span>
        </h1>
  ...
  <div class="absolute inset-0">
        <div class="absolute left-1/2 top-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/30 blur-[180px]"></div>
    </div>
    
    <!-- Content -->
    <div class="relative z-10 text-center px-6 max-w-3xl">

        @foreach ($profilos as $profilo)
        <!-- Profile Circle -->
        <div class="mx-auto mb-6 h-36 w-36 rounded-full  flex justify-center mb-8 flex items-center justify-center text-5xl font-bold text-white shadow-[0_0_80px_rgba(34,211,238,.7)]">
        
            <img src="{{ asset('storage/' . $profilo->image)}}"
            class="w-40 h-40 rounded-full obkect-cover">
        ...
        <!-- Heading -->
        <h1 class="mt-8 text-5xl md:text-7xl font-extrabold text-white">
           My name is  {{ $profilo->name }}
        </h1>
        ...
        <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            <a href="#projects"
                class="rounded-full bg-white px-8 py-3 font-semibold text-slate-900 hover:bg-slate-200 transition">
                View My Work
            </a>

            <a href="#contact"
                class="rounded-full border border-slate-500 px-8 py-3 font-semibold text-white hover:bg-white hover:text-slate-900 transition">
                Get In Touch
            </a>
        </div>
...
<!--about side -->
<section id="about" class="py-24 bg-white-950 text-white">
    <div class="max-w-6xl mx-auto px-6">

        <!-- Section Heading -->
        <div class="flex items-center gap-4 mb-10">
            <div class="w-14 h-14 rounded-2xl bg-slate-800 flex items-center justify-center shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-cyan-400" fill="none"
            ...
            <div>
                <p class="uppercase tracking-[5px] text-gray-400 text-sm">
                    About Me
                </p>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-3xl p-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
                ...
                <div
                    class="bg-slate-800 rounded-2xl p-6 text-center hover:bg-slate-700 transition">
                    <h3 class="text-4xl font-bold text-cyan-400">2+</h3>
                ...
                <div
                    class="bg-slate-800 rounded-2xl p-6 text-center hover:bg-slate-700 transition">
                    <h3 class="text-4xl font-bold text-cyan-400">18</h3>
                    <p class="text-gray-400 mt-2">
                        Years old
                    </p>
                </div>
                ...
                <div
                    class="bg-slate-800 rounded-2xl p-6 text-center hover:bg-slate-700 transition">
                    <h3 class="text-4xl font-bold text-cyan-400">React</h3>
                    <p class="text-gray-400 mt-2">
                        Currently Learning
                    </p>
                </div>
...
@endforeach
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <div>
                <p class="uppercase text-sm tracking-[5px] text-gray-400">
                    Selected Work
                </p>
        ...
        <div class="grid gap-8 md:grid-cols-2">
            ...
            <!-- Card -->
            <div class="rounded-3xl border border-slate-800 bg-slate-900 p-8 hover:border-cyan-400 transition">

                <div class="flex justify-between items-start">
                    <div class="w-14 h-14 rounded-xl bg-slate-800 flex items-center justify-center text-2xl">
                        {{ $project->icon }}
                    </div>
                ...
                <div class="mt-6 flex flex-wrap gap-2">
                    <span class="rounded-full bg-slate-800 px-3 py-1 text-sm">laravel</span>
                       <span class="rounded-full bg-slate-800 px-3 py-1 text-sm">Javascript</span>
                          <span class="rounded-full bg-slate-800 px-3 py-1 text-sm">tailwind</span>
                             <span class="rounded-full bg-slate-800 px-3 py-1 text-sm">mysql</span>
            ...
            <!--skills-->
            <section id="skills" class="bg-white-950 py-24 text-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <div>
                <p class="uppercase tracking-[4px] text-sm text-slate-400">
                    What I Do
                </p>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="rounded-3xl border border-slate-800 bg-slate-900 p-8">
                ...
                <h3 class="text-2xl font-semibold mb-8 text-gray-500">
                    Backend & Frameworks
                </h3>
                ...
                <div class="mb-6">
                    <div class="flex justify-between mb-2">
                        <span class="text-black-800">Laravel</span>
                        <span class="text-slate-900">92%</span>
                    </div>

                    <div class="h-2 bg-slate-700 rounded-full">
                        <div class="h-full w-[92%] rounded-full bg-cyan-400"></div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="h-2 bg-slate-700 rounded-full">
                        <div class="h-full w-[88%] rounded-full bg-cyan-400"></div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="h-2 bg-slate-700 rounded-full">
                        <div class="h-full w-[85%] rounded-full bg-cyan-400"></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="h-2 bg-slate-700 rounded-full">
                        <div class="h-full w-[87%] rounded-full bg-cyan-400"></div>
                    </div>
                </div>
            ...
            <div class="rounded-3xl border border-slate-800 bg-slate-900 p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="h-2 bg-slate-700 rounded-full">
                        <div class="h-full w-[93%] rounded-full bg-cyan-400"></div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="h-2 bg-slate-700 rounded-full">
                        <div class="h-full w-[90%] rounded-full bg-cyan-400"></div>
                    </div>
                </div>
        ...
        <div class="mt-8 rounded-3xl border border-slate-800 bg-slate-900 p-8">
            ...
            <div>
                ...
                <div class="h-2 bg-slate-700 rounded-full">
                    <div class="h-full w-[35%] rounded-full bg-cyan-400"></div>
                </div>
            </div>
...
<!--contact-->
<section id="contact" class="relative bg-white-500 py-24 overflow-hidden">

    <!-- Background Glow -->
    <div class="absolute inset-0 flex justify-center">
        <div class="h-[450px] w-[450px] rounded-full bg-cyan-500/20 blur-[150px]"></div>
    </div>
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div class="flex items-center gap-5 mb-12">
            ...
            <div class="w-14 h-14 rounded-2xl bg-[#102748] flex items-center justify-center shadow-lg">
            ...
            <div>
                ...
                <h2 class="text-5xl font-bold text-black-500">
                    Contact Information
                </h2>
            </div>
        ...
        <!-- Card -->
        <div class="rounded-3xl overflow-hidden border border-cyan-500/10 bg-[#0C2142]">

            <!-- Banner -->
            <div class="bg-[#08182F] p-10">
            ...
            <div class="grid md:grid-cols-2">
                ...
                <!-- Email -->
                <div class="flex items-center gap-5 p-8 border-b md:border-r border-cyan-500/10 bg-white-500">

                    <div class="w-14 h-14 rounded-xl bg-white-500 flex items-center justify-center text-cyan-400">
                        ✉️
                    </div>
                    ...
                    <div>
                        ...
                        <h4 class="font-semibold text-white-500">
                            praiseomobude13@gmail.com
                        </h4>
                    </div>
                ...
                <!-- Phone -->
                <div class="flex items-center gap-5 p-8 border-b border-cyan-500/10">

                    <div class="w-14 h-14 rounded-xl bg-[#102748] flex items-center justify-center text-cyan-400">
                        📞
                    </div>
                ...
                <!-- Location -->
                <div class="flex items-center gap-5 p-8 md:border-r border-cyan-500/10">
                ...
                <div class="flex items-center gap-5 p-8">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="https://www.github.com/praiseDev13" target="_blank"
                            class="w-12 h-12 rounded-xl bg-[#102748] hover:bg-cyan-500 flex items-center justify-center transition">
                            G
                        </a>

                        <a href="https://www.linkedin.com/omobudepraise" target="_blank"
                            class="w-12 h-12 rounded-xl bg-[#102748] hover:bg-cyan-500 flex items-center justify-center transition">
                            in
                        </a>

                        <a href="https://www.x.com/praiseDev13" target="_blank"
                            class="w-12 h-12 rounded-xl bg-[#102748] hover:bg-cyan-500 flex items-center justify-center transition">
                            X
                        </a>
